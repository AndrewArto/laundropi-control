...
export const MACHINE_CONFIGS: LaundryMachineConfig[] = [
  {
    agentId: 'Brandoa1',
    thresholds: {
      displayBrightnessOn: 95,   // lowered from 105 - W4 showing 96.9 when ON
    ...
    machines: [
      // Front camera - 4 washers (recalibrated 2026-01-24 - targeting LCD screens)
      {
        ...
        display: { x: 0.065, y: 0.590, width: 0.040, height: 0.025 },
      },
      {
  ...
  },
  {
    agentId: 'Brandoa2',
    thresholds: {
      displayBrightnessOn: 100,   // raised from 95 - W1 showing 96.7 from ambient light when idle
      clothesVariance: 60,        // lowered from 100 - dryers show 70-104 variance with clothes
      lidOpenBrightness: 130,     // raised - too many false positives at 95
    },
    machines: [
