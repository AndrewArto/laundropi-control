...
## Env files
Use separate env files to avoid mixing central and agent settings:
- `.env.central` for `npm run dev:central`
- `.env.agent` for `npm run dev:agent`

Templates: `.env.central.example`, `.env.agent.example`.
